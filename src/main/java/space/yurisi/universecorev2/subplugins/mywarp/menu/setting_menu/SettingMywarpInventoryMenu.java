package space.yurisi.universecorev2.subplugins.mywarp.menu.setting_menu;
...
import space.yurisi.universecorev2.subplugins.mywarp.menu.menu_item.BackItem;
import space.yurisi.universecorev2.subplugins.mywarp.menu.menu_item.ForwardItem;
import space.yurisi.universecorev2.subplugins.mywarp.menu.menu_item.TopItem;
import space.yurisi.universecorev2.subplugins.mywarp.menu.setting_menu.item.SettingMenuItem;
...
public class SettingMywarpInventoryMenu implements BaseMenu {

    private UniverseCoreAPIConnector connector;

    public SettingMywarpInventoryMenu(UniverseCoreAPIConnector connector){
    ...
    public void sendMenu(Player player){
        try{
            List<Item> items = this.connector.getMywarpList(player).stream()
                    .map(mywarp -> new SettingMenuItem(connector, mywarp))
