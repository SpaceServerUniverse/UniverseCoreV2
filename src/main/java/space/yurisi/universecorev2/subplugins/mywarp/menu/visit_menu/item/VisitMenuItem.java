package space.yurisi.universecorev2.subplugins.mywarp.menu.visit_menu.item;
...
public class VisitMenuItem extends AbstractItem {

    Mywarp mywarp;

    UniverseCoreAPIConnector connector;

    public VisitMenuItem(UniverseCoreAPIConnector connector, Mywarp mywarp){
